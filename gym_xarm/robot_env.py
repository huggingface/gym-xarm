...
class BaseRobotEnv(gym.Env):
    """Modified version of BaseRobotEnv to be a `gym.Env` instead of a `gymnasium_robotics.GoalEnv`"""
...
class MujocoRobotEnv(BaseRobotEnv):
    ...
    def __init__(self, default_camera_config: Optional[dict] = None, **kwargs):
        ...
        self.observation_renderer = MujocoRenderer(self.model, self.data, default_camera_config)
    ...
    def render(self):
        ...
        return self.observation_renderer.render(self.render_mode)
